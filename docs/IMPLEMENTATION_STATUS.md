...
- 严格 `ThreadContextMemory`：最小字段、tenant/user/thread namespace、默认 7 天 TTL、过期/畸形删除和实体切换优先级。
...
140 tests passed under pytest; no skips
83.95% total source coverage; 80% gate passed
