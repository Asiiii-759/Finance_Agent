...
class EvidenceBoundLLMSynthesizer:
    ...
    def __init__(
        ...
        *,
        ...
        max_evidence_tokens: int = 96_000,
        ...
        self.context_assembler = context_assembler or FinancialContextAssembler(
    ...
    def synthesize(
        ...
        *,
        ...
        user_payload, self._last_manifest = self.context_assembler.build(
            ...
            reserved_tokens=self.context_assembler.count_tokens(system_prompt),
        )
        user_prompt = json.dumps(user_payload, ensure_ascii=False)
        try:
            raw = self._chat(turn, runtime_policy, system_prompt, user_prompt)
